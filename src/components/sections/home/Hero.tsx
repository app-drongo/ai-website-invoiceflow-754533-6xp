...
const DEFAULT_HERO = {
  badge: 'New: AI-Powered Invoice Generation',
  title: 'Streamline your billing with',
  titleHighlight: 'InvoiceFlow',
  description:
    'The modern invoicing solution that helps small and medium businesses get paid faster. Create professional invoices, track payments, and manage your cash flow with ease.',
  features: [
  ...
  imageAlt: 'InvoiceFlow dashboard showing invoice management',
  statsLabel1: 'Faster Payments',
  statsValue1: '3x Quicker',
  statsLabel2: 'Customer Rating',
