...
const DEFAULT_FEATURES = {
  badge: 'Core Features',
  mainTitle: 'Everything You Need to Invoice Like a Pro',
  mainTitleHighlight: 'Built for Growing Businesses',
  mainDescription:
    "Streamline your billing process with InvoiceFlow's comprehensive invoicing platform. From automated recurring billing to advanced payment tracking, we've got your business covered.",
  feature1Title: 'Lightning-Fast Invoice Creation',
  feature1Description:
    'Create professional invoices in seconds with smart templates, auto-fill client data, and bulk invoice generation for recurring customers.',
  feature1Badge: 'Speed',
  feature2Title: 'Bank-Level Security & Compliance',
  feature2Description:
    'PCI DSS compliant with 256-bit encryption, secure payment processing, and automated data backups to protect your financial data.',
  feature2Badge: 'Security',
  feature3Title: 'Mobile Invoice Management',
  feature3Description:
    'Send invoices, track payments, and manage clients on-the-go with our native mobile apps for iOS and Android.',
  feature3Badge: 'Mobile',
  feature4Title: 'Multi-Currency & Global Payments',
  feature4Description:
    'Accept payments in 130+ currencies with automatic exchange rates and support for international tax regulations.',
  feature4Badge: 'Global',
  feature5Title: 'Advanced Financial Reporting',
  feature5Description:
    'Track cash flow, payment trends, and client performance with real-time dashboards and 25+ financial reports.',
  feature5Badge: 'Analytics',
  feature6Title: 'Smart Payment Automation',
  feature6Description:
    'Set up recurring invoices, automatic payment reminders, and late fee calculations to reduce manual work by 80%.',
  feature6Badge: 'Automation',
  feature7Title: 'Seamless Integrations',
  feature7Description:
    'Connect with QuickBooks, Xero, Stripe, PayPal, and 50+ other tools via our robust API and pre-built integrations.',
  feature7Badge: 'Integration',
  feature8Title: 'Expert Customer Success',
  feature8Description:
    'Get personalized onboarding, live chat support, and dedicated account management to maximize your invoicing efficiency.',
  feature8Badge: 'Support',
  feature9Title: 'Enterprise-Grade Privacy',
  feature9Description:
    'Your financial data stays private with GDPR compliance, role-based access controls, and zero third-party data sharing.',
  feature9Badge: 'Privacy',
  ctaQuestion: 'Ready to transform your invoicing process?',
