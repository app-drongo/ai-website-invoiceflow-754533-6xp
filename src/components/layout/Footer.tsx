...
const DEFAULT_FOOTER = {
  logoText: 'InvoiceFlow',
  companyDescription:
    'Streamline your invoicing process with automated billing, payment tracking, and professional invoice templates. Trusted by over 10,000 businesses worldwide to manage their financial workflows efficiently.',
  contactEmail: 'support@invoiceflow.com',
  contactPhone: '+1 (555) 847-2901',
  contactAddress: '456 Finance Street, Suite 200, Business District',
  newsletterTitle: 'Invoice Updates',
  newsletterPlaceholder: 'Enter your business email',
  newsletterDisclaimer:
    'Get invoicing tips, feature updates, and billing best practices. Unsubscribe anytime.',
  section1Title: 'Platform',
  section2Title: 'Company',
  section3Title: 'Support',
  section4Title: 'Legal',
  copyrightText: '© 2024 InvoiceFlow. All rights reserved.',
  madeWithText: 'by the InvoiceFlow team',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/invoiceflow',
  social2Href: 'https://facebook.com/invoiceflow',
  social3Href: 'https://instagram.com/invoiceflow',
  social4Href: 'https://linkedin.com/company/invoiceflow',
  social5Href: 'https://github.com/invoiceflow',
} as const;
  ...
  const footerSections = [
    {
      ...
      links: [
        { name: 'Invoice Templates', href: '/templates', editableId: 'link-footer-templates' },
        { name: 'Payment Processing', href: '/payments', editableId: 'link-footer-payments' },
        { name: 'Recurring Billing', href: '/recurring', editableId: 'link-footer-recurring' },
        { name: 'Client Management', href: '/clients', editableId: 'link-footer-clients' },
        { name: 'Reporting', href: '/reports', editableId: 'link-footer-reports' },
    ...
    },
    {
      ...
      links: [
        { name: 'About InvoiceFlow', href: '/about', editableId: 'link-footer-about' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Getting Started', href: '/onboarding', editableId: 'link-footer-onboarding' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Refund Policy', href: '/refunds', editableId: 'link-footer-refunds' },
      ],
    },
  ];
